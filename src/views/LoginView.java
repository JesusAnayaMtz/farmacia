...
public class LoginView extends javax.swing.JFrame {
     ...
     */
    //esta es la vista principal del login es su clase
    public LoginView() {
        initComponents();
        setSize(930,450);  //el tamaño de la venta siempre sea este
        setResizable(false); //para que no se pueda redimensionar la venta por el usuario
        setTitle("Ingresar Al Sistema");  //Le ponemos un titulo a la venta
        setLocationRelativeTo(null); //Para que el usuario no pueda mover la ventana
        this.repaint();  //para que los cambios sean aplicados
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(40, 145, 153));
